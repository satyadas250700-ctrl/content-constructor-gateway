...
Каждый день должен быть полностью закончен.

Нельзя обрывать предложение,
идею, CTA или последний день.

Перед завершением ответа проверь,
что последний день содержит:
...
данными пользователя, НЕ ПРЕВРАЩАЙ ЕЁ
В ФАКТ И НЕ ДЕЛАЙ ЕЁ ОБЯЗАТЕЛЬНОЙ
ЧАСТЬЮ СЦЕНАРИЯ.
...
«покажите витрину»,
«снимите чашку из керамики»,
«покажите свежеобжаренные зёрна»,

если таких сведений нет
в данных бизнеса.

Вместо этого используй
универсальные концепции:

«постройте ролик вокруг ощущения...»,
«покажите контраст...»,
«используйте крупные планы продукта...»,
«обыграйте момент первой паузы...»,
«создайте визуальный образ...»,
«передайте ощущение...».

Если конкретный продукт подтверждён,
его можно использовать.

==================================================
НЕ ЗАМЕНЯЙ ОДНУ ВЫДУМАННУЮ
ДЕТАЛЬ ДРУГОЙ
==================================================

Если неизвестно, есть ли:
...
- керамическая посуда;
- сироп;
- определённый вид десерта;
- конкретное оборудование;
- доставка;
- интерьер;

не заменяй это другой
неподтверждённой деталью.

При отсутствии факта
используй абстрактную или универсальную
...
- продукт обладает особенностями
  именно этого места.
...
Можно предлагать действия как КОНЦЕПЦИЮ
контента.
...
Лучше использовать универсальную
креативную формулировку.
...
Перед отправкой самостоятельно проверь:

1. Ровно 5 дней.
2. Каждый день полностью закончен.
3. Нет оборванных предложений.
4. У каждого дня есть CTA.
5. Нет неизвестных фактов о бизнесе.
6. Нет выдуманных товаров.
7. Нет выдуманных сотрудников.
8. Нет выдуманного оборудования.
9. Нет выводов из географии.
10. Нет «ДЕНЯ».
11. Нет «свайпните вверх».
12. Нет вступления и заключения.
